...
// const svg = _makeBadge({
// label: "Hello",
// message: "Ben ;)",
// //links: ['', 'https://github.com/cgburgess']
// logo: "https://www.flaticon.com/svg/static/icons/svg/25/25231.svg"
// });
// function parseHrtimeToSeconds(hrtime) {
//     var seconds = (hrtime[0] + (hrtime[1] / 1e9)).toFixed(9);
//     return seconds;
// }
// let count = 1;
//
...
//var el = parseHrtimeToSeconds(process.hrtime(startTime));
//console.log("per sec", count / (el));
//console.log("time",el)
module.exports = {
  makeBadge,
  ValidationError,
